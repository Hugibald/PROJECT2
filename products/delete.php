...
if ($row['product_picture'] !== 'product.jpg') {
    $file = "../pictures/products/" . $row['product_picture'];
    if (is_file($file)) {
        unlink($file);
    }
}
...
$result = mysqli_query($connect, $deleteSql);
    ...
    if($result){
        $success_error_message = "The product was deleted.";
    } else{
    ...
    <div class="container  mb-3">
        <div class="row">
            <div class="col col-md-6">
                <h3 class="text py-2">Delete a product</h3>
